...
**星へ旅立ったハムスターたちの名前、物語、そして小さな光を残す場所。**
...
鼠鼠星球（OmwStar）は、ハムスターのための軽量な記念アーカイブサイトです。長期的な目標は、プレイヤーが大切にしていたハムスターたちを収録し、すでに星へ到着した小さな住人たちをやさしく覚え続けることです。
...
- **記念アーカイブ** - 名前、性格、好きな食べ物、星へ到着した日、伝えたい言葉を記録
